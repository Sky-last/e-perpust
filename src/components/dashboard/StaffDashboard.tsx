      ...
      <div className="flex-1 h-screen flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <span className="text-[9px] bg-cyan-500/10 text-cyan-400 font-extrabold px-2.5 py-0.5 rounded-full uppercase border border-cyan-500/20">
                Administrator â€¢ Perpustakaan Kita
              </span>
        ...
        <main className="flex-1 overflow-y-auto p-4 lg:p-8 scrollbar-thin scrollbar-thumb-slate-800">
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            {/* â”€â”€ TRANSACTIONS (UNDUHAN) TAB â”€â”€ */}
            ...
            {activeMenu === 'cms' && (
              <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gradient-to-r from-blue-900/40 via-indigo-900/30 to-purple-900/40 border border-blue-500/30 rounded-2xl p-6 shadow-xl relative overflow-hidden">
                  <div className="relative z-10">
                    ...
                    <p className="text-xs text-slate-300 max-w-2xl mt-1 leading-relaxed">
                      Ubah nama perpustakaan, teks slogan hero, banner pengumuman, hingga deskripsi formulir masukan pengunjung.
                      Semua perubahan tersimpan di database dan langsung aktif di halaman depan secara real-time!
                    </p>
                  </div>
                ...
                <form onSubmit={handleSaveCmsSubmit} className="space-y-6">
                  ...
                  {/* Section 7: Form Masukan & Saran Pengunjung */}
                  <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-5">
                    <div className="flex items-center gap-3 pb-3 border-b border-slate-800">
                      ...
                      <div>
                        <h3 className="text-sm font-black text-white">7. Pengaturan Formulir Masukan Pengunjung</h3>
                        <p className="text-[11px] text-slate-400">Atur teks judul, badge, dan keterangan formulir masukan &amp; pesan pengunjung di Landing Page.</p>
                      </div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-xs font-bold text-slate-300 uppercase tracking-wider mb-2">Badge Section Masukan</label>
                        <input type="text" value={cmsContactBadge} onChange={(e) => setCmsContactBadge(e.target.value)}
                          placeholder="Contoh: Masukan & Saran" className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-xs text-white placeholder-slate-600 focus:outline-none focus:border-cyan-500" />
                        <p className="text-[10px] text-slate-500 mt-1">Badge kecil di atas judul form masukan.</p>
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-slate-300 uppercase tracking-wider mb-2">Judul Section Masukan</label>
                        <input type="text" value={cmsContactTitle} onChange={(e) => setCmsContactTitle(e.target.value)}
                          placeholder="Contoh: Kirim Masukan atau Pertanyaan" className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-xs text-white placeholder-slate-600 focus:outline-none focus:border-cyan-500" />
                        <p className="text-[10px] text-slate-500 mt-1">Judul utama section form masukan di website.</p>
                      </div>
                      <div className="md:col-span-2">
                        <label className="block text-xs font-bold text-slate-300 uppercase tracking-wider mb-2">Subtitle / Keterangan Form Masukan</label>
                        <textarea rows={2} value={cmsContactSubtitle} onChange={(e) => setCmsContactSubtitle(e.target.value)}
                          placeholder="Contoh: Punya saran, kendala unduhan buku digital, atau pertanyaan? Kirimkan pesan Anda melalui formulir di bawah ini." className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-xs text-white placeholder-slate-600 focus:outline-none focus:border-cyan-500 leading-relaxed" />
                        <p className="text-[10px] text-slate-500 mt-1">Deskripsi pengantar bagi pengunjung untuk mengirimkan masukan.</p>
                      </div>
                    </div>
                  </div>
            ...
            {/* â”€â”€ PESAN & MASUKAN USER TAB â”€â”€ */}
            {activeMenu === 'messages' && (
              <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
